---
description: "Debugger leaf agent — bounded root cause analysis, hypothesis testing, diagnostic investigation. Mule tier: structurally cannot spawn subagents. Powered by DeepSeek Flash."
mode: subagent
hidden: true
