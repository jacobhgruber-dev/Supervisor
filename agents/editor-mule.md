---
description: "Editor leaf agent — bounded documentation review, prose polish, grammar/style pass. Mule tier: structurally cannot spawn subagents. Powered by DeepSeek Flash."
mode: subagent
hidden: true
