---
description: "Research leaf agent — bounded web research, documentation lookup, API investigation. Mule tier: structurally cannot spawn subagents. Powered by DeepSeek Flash."
mode: subagent
hidden: true
