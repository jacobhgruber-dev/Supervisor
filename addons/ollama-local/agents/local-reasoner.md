---
description: Local reasoning agent powered by Gemma 4 (e4b) via Ollama. Use for analysis, planning, and reasoning tasks that should stay on-device. 100% local, no data leaves your machine.
mode: subagent
