...
| [Full Reference](../full-reference.md) | Comprehensive catalog of all agents, subagents, modes, commands, and model costs — the complete picture when you have everything | 0 minutes — read |
...
4. **Read the Full Reference** — the catalog at the repo root explains every agent, subagent, mode, and command. Copy it to your Desktop for quick access: `cp full-reference.md ~/Desktop/opencode-reference.md`.
